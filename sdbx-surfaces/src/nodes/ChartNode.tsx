...
export default function Example({
  ...
  return (
    ...
    <svg width={width} height={height}>
      <RadialGradient from='#17EAD9' to='#65799B' id="visx-pie-gradient" />
      <rect rx={14} width={width} height={height} fill="url('#visx-pie-gradient')" />
      <Group top={centerY + margin.top} left={centerX + margin.left} >
        <Pie
          data={
            selectedBrowser ? browsers.filter(({ label }) => label === null) : browsers
          }
          pieValue={usage}
          outerRadius={radius}
          ...
          {(pie) => (
            <AnimatedPie<BrowserUsage>
              ...
              onClickDatum={({ data: { label } }) =>
                animate &&
                setSelectedBrowser(selectedBrowser && selectedBrowser === null ? null : label)
              }
        ...
        <Pie
          ...
          innerRadius={radius - donutThickness - 25}
          cornerRadius={3}
          padAngle={0.005}
        >
          {(pie) => (
        ...
        <Pie
          ...
          pieValue={frequency}
          pieSortValues={() => -1}
          outerRadius={radius - donutThickness *4}
        >
          {(pie) => (
